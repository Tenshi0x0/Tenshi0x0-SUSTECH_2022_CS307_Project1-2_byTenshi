...
public class Model {
    ...
    public static HashSet<String> setOfModel = new HashSet<String>();
    ...
    private void init() {
        try {
            getConnection();
            PreparedStatement preparedStatement = con.prepareStatement("truncate table model");
    ...
    private static void loadData(int a, String b, String c, String d, int e) throws SQLException {
        if (con != null) {
            stmt.setInt(1, a);
            stmt.setString(2, b);
            stmt.setString(3, c);
    ...
    public void insert(int a, String b, String c, String d, int e) {
        try {
            getConnection();
            String sql = "insert into model (id, number, model, name, unit_price)" + a + ",'" + b + ",'" + c + ",'" + d + ",'" + e + "');";
        ...
        try (BufferedReader infile = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = infile.readLine()) != null) {
                ...
                if (parts.length > 1) {
                    ...
                    loadData(Integer.parseInt(parts[0]), parts[1], parts[2], parts[3], Integer.parseInt(parts[4]));
